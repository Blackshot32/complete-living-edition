...
public class MoCEntityDuck extends MoCEntityAnimal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new net.minecraft.world.entity.ai.goal.AvoidEntityGoal<>(this, drzhark.mocreatures.entity.hunter.MoCEntityFox.class, 8.0F, 1.2D, 1.4D));
        this.goalSelector.addGoal(2, new net.minecraft.world.entity.ai.goal.AvoidEntityGoal<>(this, drzhark.mocreatures.entity.hunter.MoCEntityCrocodile.class, 10.0F, 1.2D, 1.4D));

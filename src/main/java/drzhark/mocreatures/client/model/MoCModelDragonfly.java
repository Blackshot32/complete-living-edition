...
public class MoCModelDragonfly<T extends MoCEntityDragonfly> extends EntityModel<T> implements IPartialTransparencyModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "dragonfly"), "main"
    );
    ...
    public void renderTransparentParts(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        this.WingRearRight.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.WingFrontRight.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.WingFrontLeft.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.WingRearLeft.render(poseStack, buffer, packedLight, packedOverlay, color);
    }

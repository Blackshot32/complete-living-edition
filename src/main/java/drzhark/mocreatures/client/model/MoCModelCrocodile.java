...
public class MoCModelCrocodile<T extends MoCEntityCrocodile> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "crocodile"), "main"
    );
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight,
        ...
        this.UJaw.render(poseStack, buffer, packedLight, packedOverlay, color);
        ...
        this.TailD.render(poseStack, buffer, packedLight, packedOverlay, color);
        ...
        this.UJaw2.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LJaw2.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.TeethA.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.TeethB.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.TeethC.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.TeethD.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.TeethF.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.Spike0.render(poseStack, buffer, packedLight, packedOverlay, color);
        ...
        this.SpikeBack0.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.SpikeBack1.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.SpikeBack2.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.SpikeBack3.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.SpikeBack4.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.SpikeBack5.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.SpikeEye.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.SpikeEye1.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.TeethA1.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.TeethB1.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.TeethC1.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.TeethD1.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
}

...
public class MoCModelDolphin<T extends MoCEntityDolphin> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "dolphin"), "main"
    );
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight,
        ...
        this.LTailFin.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.RTailFin.render(poseStack, buffer, packedLight, packedOverlay, color);

...
public class MoCModelJellyFish<T extends MoCEntityJellyFish> extends EntityModel<T> implements IPartialTransparencyModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "jellyfish"), "main"
    );
    ...
    public void renderToBuffer(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn,
        ...
        renderOpaqueParts(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, color);
    ...
    public void renderTransparentParts(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        this.HeadSmall.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.Body.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.BodyCenter.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.BodyBottom.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.Side1.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.Side2.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.Side3.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.Side4.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LegSmall1.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LegC1.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LegC2.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.LegC3.render(poseStack, buffer, packedLight, packedOverlay, color);
        ...
        this.Leg9.render(poseStack, buffer, packedLight, packedOverlay, color);
    }

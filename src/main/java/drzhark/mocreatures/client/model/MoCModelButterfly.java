...
public class MoCModelButterfly<T extends MoCEntityButterfly> extends EntityModel<T> implements IPartialTransparencyModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("mocreatures", "butterfly"), "main");
    ...
    public void renderOpaqueParts(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        this.front_legs.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.right_antenna.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.left_antenna.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.rear_legs.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.mid_legs.render(poseStack, buffer, packedLight, packedOverlay, color);
    ...
    public void renderTransparentParts(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        this.wing_right_front.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.wing_left_front.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.wing_right_back.render(poseStack, buffer, packedLight, packedOverlay, color);
        this.wing_left_back.render(poseStack, buffer, packedLight, packedOverlay, color);
    }
    
    private void renderFoldedWings(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {

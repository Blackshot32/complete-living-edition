...
public class MoCModelRoach<T extends MoCEntityRoach> extends EntityModel<T> implements IPartialTransparencyModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath("mocreatures", "roach"),
            "main"
    );
    ...
    public void renderOpaqueParts(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ...
        thorax.render(poseStack, buffer, packedLight, packedOverlay, color);
        frontLegs.render(poseStack, buffer, packedLight, packedOverlay, color);
        midLegs.render(poseStack, buffer, packedLight, packedOverlay, color);
        rearLegs.render(poseStack, buffer, packedLight, packedOverlay, color);
        abdomen.render(poseStack, buffer, packedLight, packedOverlay, color);
        tailL.render(poseStack, buffer, packedLight, packedOverlay, color);
        tailR.render(poseStack, buffer, packedLight, packedOverlay, color);

        if (!flying) {
            lShellClosed.render(poseStack, buffer, packedLight, packedOverlay, color);
            rShellClosed.render(poseStack, buffer, packedLight, packedOverlay, color);
        } else {
            lShellOpen.render(poseStack, buffer, packedLight, packedOverlay, color);
            rShellOpen.render(poseStack, buffer, packedLight, packedOverlay, color);
        }
    }

...
public interface IPartialTransparencyModel<T extends Entity> {
     ...
     */
    void renderOpaqueParts(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color);
    
    /**
     * Renders transparent parts of the model
     */
    void renderTransparentParts(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color);
